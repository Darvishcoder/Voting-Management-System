 ...
 */
public class Chhattisgarh extends javax.swing.JFrame {

    /**
     * Creates new form Chhattisgarh
     */
    public Chhattisgarh() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Chhattisgarh");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(290, 10, 190, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Chhattisgarh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Chhattisgarh().setVisible(true);
            }
        });
    }
